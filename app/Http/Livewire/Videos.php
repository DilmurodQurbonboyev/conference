...
class Videos extends Component
{
    ...
    {
        $users = User::all();
        $videosCategories = ListCategory::where('list_type_id', 8)->where('parent_id', 0)->get();
        $query = Lists::query()->where('list_type_id', 8);
        ...
        return view('livewire.videos', compact('videosCategories', 'videos', 'users'));
    }
}
