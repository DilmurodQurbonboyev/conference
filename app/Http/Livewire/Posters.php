...
class Posters extends Component
{
    ...
    {
        $users = User::all();
        $postersCategories = ListCategory::where('list_type_id', 2)->where('parent_id', 0)->get();
        $query = Lists::query()->where('list_type_id', 2);
        ...
        return view('livewire.posters', compact('postersCategories', 'posters', 'users'));
    }
}
