...
class Events extends Component
{
    ...
    {
        $users = User::all();
        $eventsCategories = ListCategory::where('list_type_id', 9)->where('parent_id', 0)->get();
        $query = Lists::query()->where('list_type_id', 9);
        ...
        return view('livewire.events', compact('eventsCategories', 'events', 'users'));
    }
}
