...
class Answers extends Component
{
    ...
    {
        $users = User::all();
        $answersCategories = ListCategory::where('list_type_id', 3)->where('parent_id', 0)->get();
        $query = Lists::query()->where('list_type_id', 3);
        ...
        return view('livewire.answers', compact('answersCategories', 'answers', 'users'));
    }
}
