...
@section('content')
    <div class="p-3 d-flex justify-content-end">
        <x-show-button destroyAction="{{ route('news-category.destroy', $newsCategory->id) }}"
                       createAction="{{ route('news-category.create') }}"
                       indexAction="{{ route('news-category.index') }}"
                       editAction="{{ route('news-category.edit', $newsCategory->id ) }}"/>
    </div>
