        ...
        <div class="card-body">
            <form action="{{ route('managements.update', $managements->id) }}" method="post">
                        ...
                        <div class="tab-pane fade show" id="{{ $lang }}" role="tabpanel" aria-labelledby="{{ $lang }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="leader_{{ $lang }}"
                                       id="leader_{{ $lang }}"
                                       value="{{ $managements->translate($lang)->leader ?? '' }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description_{{ $lang }}"
                                          ...
                                          cols="30"
                                          rows="4">{{ $managements->translate($lang)->description ?? '' }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                <div class="form-group">
                    ...
                    <img src="{{ $managements->image }}" class="p-2" width="30%" alt="">
                </div>
                <div class="form-group">
                    ...
                    <img src="{{ $managements->anons_image }}" class="p-2" width="30%" alt="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="status" id="status">
                        <option
                            value="2" {{ $managements->status == "2" ? 'selected' : '' }}>{{ tr('Active') }}</option>
                        <option
                            value="1" {{ $managements->status == "1" ? 'selected' : '' }}>{{ tr('Inactive') }}</option>
                    </select>
                </div>
                <div class="form-group">
