        ...
        <div class="card-body">
            <form action="{{ route('pages.update', $pages->id) }}" method="post">
                ...
                <div class="tab-content">
                    @foreach (Config::get('translatable.locales') as $lang)
                        <div class="tab-pane fade show" id="{{ $lang }}" role="tabpanel" aria-labelledby="{{ $lang }}">
                            ...
                            <x-form.content name="content_{{ $lang }}"
                                            value="{!! $pages->translate($lang)->content ?? '' !!}"/>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="thumbnail_{{ $lang }}" class="form-control" type="text"
                                           name="pdf_{{ $lang }}"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="thumbnail3" class="form-control" type="text" value="{!! $pages->body_image !!}"
                               name="body_image">
                        <span class="input-group-btn">
