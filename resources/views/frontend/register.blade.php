                            ...
                            <div class="application-form-in">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country"
                                        ...
                                        @if ($app->getLocale() == 'ru')
                                        <option value="{{ $country->name_ru }}" {{old ('country')==$country->name_ru ?
                                            'selected' : ''}}>{{ $country->name_ru }}
                                        </option>
                                        @else
                                        <option value="{{ $country->name_en }}" {{old ('country')==$country->name_en ?
                                            'selected' : ''}}>{{ $country->name_en }}
                                        </option>
                                        @endif
                                        @endforeach
                                    </select>
